"""Sphinx configuration for pv-tool documentation."""
...
# Autosummary settings (disabled - using automodule directly)
...
# Shibuya theme options - using "teal" for a fresh, professional look
html_theme_options = {
    "accent_color": "teal",
